...
const HackOnHeader = () => {
  ...
  const handleScanResult = async (message) => {
    try {
      ...
      const TeamsData = await GetSingleDocument(message, HackOnTeamsCollection);
      return setScanenedteamdata(TeamsData);
    } catch (error) {
  ...
  return (
    <div className="flex items-center justify-between">
      <h1 className="text-2xl md:text-3xl font-semibold">Hackathon Teams</h1>
