...
const AllReportsDocs = ({ isSelect, SetSelect, BucketID }) => {
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-5">
          {appWriteFiles.map((file) => (
            <div
              key={file.id}
              className={`flex justify-between  flex-col md:flex-row items-center w-full border overflow-scroll gap-2 p-3 rounded-sm shadow-sm ${
